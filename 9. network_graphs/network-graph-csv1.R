...
nodes <- read.csv("/Users/sanjitkumar/Documents/VIT_DOC/vit_semester_6/B2 - Data Visualisation/lab/final_assessment_test/Media-Example-NODES.csv", header=T, as.is=T)

nodes

links <- read.csv("/Users/sanjitkumar/Documents/VIT_DOC/vit_semester_6/B2 - Data Visualisation/lab/final_assessment_test/Media-Example-EDGES.csv", header=T, as.is=T)
...
path1 <- distances(net, v=V(net)[media=="NY Times"], to=V(net), weights=NA)
path1
V(net)
...
path5 <- shortest_paths(net, 
                            from = V(net)[media=="USA Today"], 
                            to  = V(net)[media=="BBC"],
