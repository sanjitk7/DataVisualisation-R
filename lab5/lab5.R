...
qplot(Wind, Solar.R, data = airquality)

qplot(log(Wind), log(Solar.R), data = airquality)

qplot(log(Wind), log(Solar.R), data = airquality[30:40],colour=color)

qplot(log(Day), log(Month), data = airquality, shape=cut)
